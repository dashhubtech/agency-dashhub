    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center justify-center w-full h-full">
                ...
                >
                    <h1 className="text-6xl md:text-8xl font-bold bg-clip-text text-transparent bg-linear-to-b from-black to-black/70 dark:from-white dark:to-white/70 drop-shadow-xs">
                        {title}
                    </h1>
                    <p className="text-xl md:text-2xl font-medium bg-clip-text text-transparent bg-linear-to-b from-black/90 to-black/50 dark:from-white/90 dark:to-white/50">
                        {subtitle}
                    </p>
                </motion.div>
            </div>

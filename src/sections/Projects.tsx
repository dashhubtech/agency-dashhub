        ...
        <div className="mt-10 md:mt-16 lg:mt-20">
          {projects.map(({ name, image }) => (
            <Link
              href="#"
              key={name}
              className="border-t last:border-b border-stone-800 border-dotted py-6 md:py-8 lg:py-10 flex flex-col relative group/project"
            >
              <div className="absolute bottom-0 left-0 w-full  group-hover/project:h-full transition-all duration-700 h-0 bg-stone-300" />

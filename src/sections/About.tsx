        ...
        <div className="container flex flex-col items-center justify-center flex-1">
          ...
          <TextAnimation animateOnScroll={true} delay={0.7}>
            <p className="font-semi-bold text-lg md:text-2xl ">
              ...
              is an innovative business development company, that empowers founders and
              entrepreneurs to turn their bold ideas into flourishing, high-growth businesses.
              Established in 2022, we have dedicated ourselves to crafting a unique Venture Studio
              model, where we collaborate with visionary individuals to refine business models,
              identify market opportunities, design sustainable growth strategies, and provide
              unparalleled support in product development, branding, and scaling.
            </p>
          </TextAnimation>
        </div>
      </div>
        ...
        <div className=" flex flex-col  items-center justify-center flex-1 gap-5">
          ...
          <TextAnimation delay={0.5}>
            <p className=" px-4 font-semi-bold text-2xl md:text-5xl text-right ">
              ...
              branding, and provide the tools needed to scale your business effectively. Our goal is
              to guide you through every stage of growth with smart, sustainable solutions.
            </p>
          </TextAnimation>
        </div>
      </div>
